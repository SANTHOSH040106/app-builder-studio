...
export const FeaturedHospitals = () => {
  return <div className="px-4 py-6">
      ...
      <Carousel className="w-full">
        <CarouselContent>
          {hospitals.map(hospital => <CarouselItem key={hospital.id} className="md:basis-1/2 lg:basis-1/3">
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {hospital.specialties.map(specialty => <Badge key={specialty} variant="secondary" className="text-xs">
                        {specialty}
                      </Badge>)}
                  </div>
                </CardContent>
